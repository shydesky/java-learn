...
/*        WorkQueue wq=new WorkQueue(10);//10个工作线程
        ...
        Mytask r[]=new Mytask[20];//20个任务
        /*ExecutorService trxsHandlePool = Executors
                .newFixedThreadPool(3);*/
        ThreadPoolExecutor pool = new ThreadPoolExecutor(1,2,1,TimeUnit.SECONDS,new ArrayBlockingQueue(3));
        for(int i=0;i<20;i++){
